...
const STEPS: Step[] = [
  ...
  { target: "nav-home", title: "Home", body: "Your dashboard: totals at a glance, maintenance due, ammo goals, and recent range sessions. Click a section title to fold it away." },
  { target: "nav-armory", title: "Armory", body: "The Armory menu holds your firearms (with serials, photos, receipts, cleaning and malfunction logs), accessories, permits & documents with expiration warnings, and the printable Inventory Report for insurance." },
  ...
  { target: "nav-range", title: "Range", body: "The Range menu holds the Range Log (one line per trip, with scores and PASS/FAIL), Log a Range Session, Courses of Fire and target types, the par timer, and your range bag checklist." },
  ...
  { target: "nav-settings", title: "Settings, Controls & Help", body: "The gear menu: Controls customizes each page (dropdown lists, defaults, dashboard layout). Settings manages the app itself (security, backups, import/export, display, updates). Help has short guides for everything." },
