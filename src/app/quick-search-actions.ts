...
const PAGES: QuickHit[] = [
  ...
  { group: "Pages", label: "Controls (dropdown lists, home layout)", href: "/controls" },
  ...
  { group: "Settings", label: "Counts (correct rounds / ammo)", href: "/settings#settings-counts" },
  { group: "Settings", label: "Range Session Defaults", href: "/settings#settings-range-session-defaults" },
  { group: "Settings", label: "Maintenance", href: "/settings#settings-maintenance" },
  { group: "Settings", label: "Ammo defaults", href: "/settings#settings-ammo" },
  { group: "Settings", label: "Reminders", href: "/settings#settings-reminders" },
