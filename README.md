...
| **TAC-QUAL** | Instructor app: classes, student roster, multi-shooter qualifications | not started (0.1.0 planned) | — |
...
- `apps/tac-qual/`: TAC-QUAL, the instructor app

Each app keeps its own name, icon, data folder, version number and changelog.

## Releases

Tags are per app: `tac-log-v0.8.0`, and later `tac-qual-v0.1.0`. A change to the shared core is tested in both apps before either is released.
