...
| --- | --- | --- | --- |
| **TAC-LOG** | Personal firearm inventory, ammo, courses of fire, range sessions | 0.9.0 | `CHANGELOG.md`, `SETUP.md` |
| **TAC-QUAL** | Classes, student roster, multi-shooter qualifications | not started (0.1.0 planned) | — |
...
Tags are per app: `tac-log-v0.9.0`, and later `tac-qual-v0.1.0`. A change to the shared core is tested in both apps before either is released.
